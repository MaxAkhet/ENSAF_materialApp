    ...
    <div class="max-w-md mx-auto bg-gray-800 p-8 rounded-lg shadow-lg">
        <form action="{{ route('materiels.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <select id="departement" name="departement" class="py-2 border-gray-400 rounded-md focus:border-gray-400 focus:ring
...
dark:text-gray-300 dark:focus:ring-offset-dark-eval-1">
            ...
            <div class="mb-4">
                ...
                <select id="categorie" name="categorie" class="py-2 border-gray-400 rounded-md focus:border-gray-400 focus:ring
focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-white dark:border-gray-600 dark:bg-dark-eval-1
dark:text-gray-300 dark:focus:ring-offset-dark-eval-1">
                    <option value="Mesure electrique">Mesure électrique</option>
                    <option value="Alimentations et generateur">Alimentations et générateur</option>
                    <option value="Telecommunication">Télécommunication</option>
                    <option value="Connectiques et Outillages">Connectiques et outillages</option>
                </select>
            </div>
    
            <!-- Autres champs du formulaire (Designation, Fournisseur, etc.) -->
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <x-input id="fournisseur" class="block mt-1 w-full" type="text" name="fournisseur" required />
            </div>
    
            <!-- Prix HT -->
            <div class="mb-4">
                <x-label for="prix_ht" :value="__('Prix HT (DH)')" />
                <x-input id="prix_ht" class="block mt-1 w-full" type="number" name="prix_ht" step="0.01" required />
            </div>
    
            <!-- Date d'Acquisition -->
            <div class="mb-4">
                <x-label for="date_acquisition" :value="__('Date d\'Acquisition')" />
                <x-input id="date_acquisition" class="block mt-1 w-full" type="date" name="date_acquisition" required />
            </div>
